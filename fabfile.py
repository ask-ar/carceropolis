...
env.proj_app = real_project_name("carceiropolis")
...
def upload_template_and_reload(name):
    ...
    if 'start_supervisor' in template:
        start_supervisor = template.get('start_supervisor')
